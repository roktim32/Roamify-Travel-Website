    ...
    return (
        <>
            <header className='flex items-center justify-center w-auto h-auto absolute top-7 left-0 right-0'>
                <nav className='flex items-center justify-between roamify-container'>
                    ...
                    <ul className='flex items-center lg:hidden'>
                        <li><button type='button' className='button-emerald px-7 text-base '>Join Us</button></li>
                    </ul>
                    <ul className='hidden lg:flex items-center'>
                        <li>
                            <button onClick={onTriggerPopup} className='flex items-center justify-center transition-all duration-200 active:scale-90 cursor-pointer' type='button'>
