const Memory = ({ memory: { title, subtitle, text, img, experience } }) => {
    ...
    return (
        <div className='relative my-16 md:mb-7'>
            <div className='roamify-container flex items-center justify-between gap-16 xl:gap-9 lg:flex-col-reverse'>
                ...
                <div className='grid items-center w-full max-w-2xl lg:text-center'>
                    ...
                    <div className='grid items-center grid-cols-3 gap-7 xl:gap-3'>
                        {experience?.map((val, i) => (
                            <div key={i} className="bg-gradient-to-b from-emerald-300 to-green-300 shadow-lg shadow-emerald-200 rounded-lg flex items-center justify-center flex-col text-slate-900 text-center py-7 px-5 xl:p-5 filter transition-all duration-400 hover:scale-105 cursor-pointer">
